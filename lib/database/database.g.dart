...
class PeopleData extends DataClass implements Insertable<PeopleData> {
  ...
  PeopleData copyWith({int? id, String? name, DateTime? createdAt}) =>
      PeopleData(
        id: id ?? this.id,
        name: name ?? this.name,
...
class Debt extends DataClass implements Insertable<Debt> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, personId, title, amount, date, isPaid, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Debt &&
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [people, debts];
  @override
...
final class $$PeopleTableReferences
  ...
  static MultiTypedResultKey<$DebtsTable, List<Debt>> _debtsRefsTable(
    ...
    db.debts,
    aliasName: $_aliasNameGenerator(db.people.id, db.debts.personId),
  );
          ...
          prefetchHooksCallback: ({debtsRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (debtsRefs)
                    await $_getPrefetchedData<PeopleData, $PeopleTable, Debt>(
                      currentTable: table,
...
final class $$DebtsTableReferences
  ...
  static $PeopleTable _personIdTable(_$AppDatabase db) => db.people.createAlias(
    $_aliasNameGenerator(db.debts.personId, db.people.id),
  );
